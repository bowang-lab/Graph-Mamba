...
class GExphormerAttention(nn.Module):
    ...
    def __init__(self, in_dim, out_dim, num_heads, use_bias, dim_edge=None, use_virt_nodes=False):
        ...
        self.Edge_type_weights = torch.Tensor([1.0, 1.0, 1.0])
...
register_layer('GExphormer', GExphormerAttention)
...
class GExphormerFullLayer(nn.Module):
    """GExphormer attention + FFN
    """
    ...
    def __init__(self, in_dim, out_dim, num_heads,
        ...
        self.attention = GExphormerAttention(in_dim, out_dim, num_heads,
                                          use_bias=use_bias, 
                                          dim_edge=dim_edge,
...
register_layer('GExphormerLayer', GExphormerFullLayer)
